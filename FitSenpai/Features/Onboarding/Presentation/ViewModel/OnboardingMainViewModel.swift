...
class OnboardingMainViewModel: ObservableObject {
    ...
    let genderSelections: [FSSignUpItem] = [
        FSSignUpItem(title: "Male"),
        FSSignUpItem(title: "Female"),
        FSSignUpItem(title: "Other")
    ]
    ...
    let stoppingFromLivingHealthierSelections: [FSSignUpItem] = [
        FSSignUpItem(title: "Personal trainers", iconName: "ic_handshake"),
        ...
        FSSignUpItem(title: "Busy schedule", iconName: "ic_calendar"),
        FSSignUpItem(title: "Not sure where to start", iconName: "ic_frown")
    ]
    
    let wouldLikeToAccomplishSelections: [FSSignUpItem] = [
        FSSignUpItem(title: "Stay motivated and consistent", iconName: "ic_line_chart"),
    ...
    let workoutDaySelections: [FSSignUpItem] = [
        FSSignUpItem(title: "Sunday"),
        FSSignUpItem(title: "Monday"),
        FSSignUpItem(title: "Tuesday"),
        FSSignUpItem(title: "Wednesday"),
        FSSignUpItem(title: "Thursday"),
        FSSignUpItem(title: "Friday"),
        FSSignUpItem(title: "Saturday")
    ]
    
    let workoutDurationSelections: [FSSignUpItem] = [
        FSSignUpItem(title: "15 mins"),
        FSSignUpItem(title: "30 mins"),
        FSSignUpItem(title: "60 mins"),
        FSSignUpItem(title: "Other")
    ]
    
    let healthRestrictionSelections: [FSSignUpItem] = [
        FSSignUpItem(title: "None", iconName: "ic_cross"),
    ...
    let specificDietSelections: [FSSignUpItem] = [
        FSSignUpItem(title: "None", iconName: "ic_cross"),
    ...
    let foodAllergySelections: [FSSignUpItem] = [
        FSSignUpItem(title: "None", iconName: "ic_cross"),
    ...
    let eatingHabitsSelections: [FSSignUpItem] = [
        FSSignUpItem(title: "I cook most of my meals"),
        FSSignUpItem(title: "I order meal plans"),
        FSSignUpItem(title: "I eat out often"),
        FSSignUpItem(title: "I mix between cooking and ordering")
    ]
}
